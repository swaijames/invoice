...
(function ($) {
    ...
    if ($('[data-target="tooltip"]').length > 0) {
        var tooltipTriggerList = [].slice.call(document.querySelectorAll('[data-target="tooltip"]'))
    ...
    if ($('.popover-list').length > 0) {
        var popoverTriggerList = [].slice.call(document.querySelectorAll('[data-target="popover"]'))
    ...
    $('.right-position.dropdown-trigger').dropdown({
        coverTrigger: false,
        constrainWidth: false,
        alignment: "right",
    });
    ...
    // 	edge: "right",
    // });
    $('.sidenav.offsetLeft').sidenav({
        menuWidth: 400,
        edge: "left",
    });
    $('.sidenav.offsetRight').sidenav({
        menuWidth: 400,
        edge: "right",
    });
    ...
    $('.datepicker').datepicker();
    $('.carousel').carousel();
    $('.carousel.carousel-fullWidth').carousel({
        fullWidth: true
    });
    $('.carousel.carousel-indicators').carousel({
        indicators: true
    });
